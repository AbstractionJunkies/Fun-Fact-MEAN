...
const RegisterUrl: string = 'https://fun-fact.herokuapp.com/api/auth/register';
const LoginUrl: string = 'https://fun-fact.herokuapp.com/api/auth/login';
const GetLoggedUserUrl: string = 'https://fun-fact.herokuapp.com/api/auth/getLoggedUser';
